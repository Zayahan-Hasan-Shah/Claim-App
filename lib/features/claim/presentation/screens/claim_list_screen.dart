...
// import 'package:claim_app/features/claim/presentation/controllers/claim_provider.dart';
// import 'package:claim_app/features/claim/presentation/widgets/claim_card.dart';
// import 'package:claim_app/features/claim/presentation/widgets/limits_display_widget.dart';
// import 'package:claim_app/navigation/route_names.dart';
// import 'package:flutter/material.dart';
// import 'package:flutter_riverpod/flutter_riverpod.dart';
// import 'package:claim_app/core/constants/app_colors.dart';
...
//               if (claimState is ClaimLoaded && claimState.limitsState is ClaimLimitsLoaded)
//                 LimitsDisplayWidget(
//                   limits: (claimState.limitsState as ClaimLimitsLoaded).limits,
//                 ),
//               if (claimState is ClaimLoaded && claimState.limitsState is ClaimLimitsLoading)
//                 const Padding(
//                   padding: EdgeInsets.symmetric(horizontal: 16),
//                   child: LoadingIndicator(),
//                 ),
//               if (claimState is ClaimLoaded && claimState.limitsState is ClaimLimitsError)
//                 Padding(
//                   padding: const EdgeInsets.symmetric(horizontal: 16),
//                   child: CustomText(
//                     title: (claimState.limitsState as ClaimLimitsError).message,
//                     color: Colors.red,
//                   ),
//                 ),
//               const SizedBox(height: 12),
...
//                         ? 'Approved: Rs.${claim.approvedAmount?.toStringAsFixed(0)}'
//                         : '',
//                     size: 16),
//                 _buildHeadingText(
//                     claim.deductedAmount != null
//                         ? 'Deducted: Rs.${claim.deductedAmount?.toStringAsFixed(0)}'
//                         : '',
//                     size: 16),
//                 const SizedBox(height: 24),
//                 Align(
